...
## Getting started
Familiarization with Qi and its capabilities is easy. Introductory information such as API references can be found in [Overview](https://qi-docs.readthedocs.org/en/latest/Overview/) along with additional guidance in the [Video](https://qi-docs.readthedocs.org/en/latest/Videos/) section. In order to use the Qi REST API in your applications, make sure you have the following requirements:
